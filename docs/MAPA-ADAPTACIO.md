# Mapa d'adaptació — Matemàtiques 4t ESO Aplicades

**Alumne amb DIL · SIEI 50 % + aula ordinària 50 % · curs 2026-27**
...
| Informàtica i anglès | **4t ESO** | Palanca. GeoGebra, Desmos, full de càlcul i qualsevol eina digital, al nivell del grup. |

> **Aquest alumne pot arribar a la DECISIÓ de 4t. No pot arribar al CÀLCUL de 4t ni a la REDACCIÓ de 4t.**
...
## 3. Com articular el 50 % SIEI + 50 % aula ordinària

**La SIEI ha d'anar per davant, no per darrere.** Si la SIEI és el lloc on es repassa
el que no s'ha entès a l'aula, l'alumne arriba sempre tard i viu l'aula com un lloc
on no s'assabenta.

| Moment | On | Què hi fa |
|---|---|---|
| **1. Anticipació** | SIEI | Abans que el grup comenci: **cinc minuts de material físic**, després el vocabulari, l'esquema visual i **un exemple resolt sencer**. Les pàgines de concepte de cada fitxa serveixen exactament per a això. |
...
| **4. Consolidació** | SIEI | Caixa d'eines i, molt selectivament, `repas-main`. La frase model de la unitat. |

Amb 4 hores setmanals són 2 sessions de SIEI i 2 d'aula. **La sessió d'anticipació ha
...
i abans del títol, un rètol per a l'adult: «Cinc minuts abans, a la SIEI: …» amb el
...
1. **La calculadora no es negocia mai.** Científica, des del primer dia i a totes les
   activitats i proves. Per a ell és la mesura que li obre l'accés, i per això té un
...
5. **El seu rol al grup surt del seu punt fort.** És qui dibuixa, qui mesura, qui fa el
   gràfic i qui porta l'ordinador. Amb informàtica de 4t, el full de càlcul i el
   GeoGebra del producte final els pot fer ell de debò.
...
l'alumne. El que seria una frase explicativa es converteix en una pantalla de
...
amb números amagada fins que l'alumne mou el punt.
...
A cada unitat hi ha **un exercici que trenca la regla que l'alumne s'haurà fabricat
...
la buida per al cas de l'alumne.
...
**14–30 setembre · 6 sessions · llibre `4eso-apl-ud1`**
...
**Base prèvia (SIEI):** `1eso-ud5-2`, `1eso-ud5-5` (decimals i quadrats perfectes),
...
**6 octubre – 3 novembre · 15 sessions · llibre `4eso-apl-ud2`**
...
en una sola multiplicació i elimina el pas on un alumne amb aritmètica de 5è es perd.

**Base prèvia (SIEI):** `1eso-ud4-7`, `2eso-ud2-3`, `2eso-ud2-5`.
...
**Producte «Informe de decisió de compra»:** **ell munta el full de càlcul i el diagrama
...
**12–27 gener · 7 sessions · llibre `4eso-apl-ud3`**
...
**Base prèvia (SIEI):** `2eso-ud2-1`, `2eso-ud2-2`, `2eso-ud2-4`, `2eso-ud5-3`,
`2eso-ud5-12`.
...
**Producte «A escala real»:** ell fa el mesurament i el dibuix del plànol.
...
**2 febrer – 3 març · 12 sessions · llibre `4eso-apl-ud5`**
...
de calculadora, sense manipulació. Val la pena que ho vegi ell.
...
ja portarà treballada des de la U2 i la U3. No és millor model: és el model que ell ja té.
Estrenar-ne un de nou al febrer és el que convé evitar, no la balança en si.

**Base prèvia (SIEI, i amb temps):** `2eso-ud4-1` (la balança), `2eso-ud4-3` (solució i
...
### U5 · La paràbola
**9–26 març · 8 sessions · llibre `4eso-apl-ud6`**
...
és exactament el canal on té nivell de 2n ESO, treballat amb GeoGebra, on en té de 4t.

**Objectiu nuclear:** llegir orientació, vèrtex, talls i eix de simetria, i dir què
significa cada element en el fenomen.

**Base prèvia (SIEI):** `2eso-ud3-2`, `2eso-ud3-3`, `3eso-ud6-2`.
...
**13 abril – 6 maig · 10 sessions · llibre `4eso-apl-ud8`**
...
**Base prèvia (SIEI):** la unitat `2eso-ud6` **sencera**, «Dades que parlen». És de les
poques vegades que una unitat de 2n cobreix gairebé tot el nucli de la de 4t: no la
fragmentis.
...
**13 maig – 10 juny · 10 sessions · llibre `4eso-apl-ud9`**
...
**Base prèvia (SIEI):** `3eso-ud2-2` (el llenguatge de l'atzar), `3eso-ud2-3` (comptar
...
**Va més enllà de les matemàtiques.** Un perfil amb DIL té més vulnerabilitat davant
...
- **UD4 «Mesura indirecta»** (`4eso-apl-ud4`) — semblança, ombres i Pitàgores. Si la fas,
  **és la segona millor unitat del curs per a aquest alumne**: sortir a mesurar l'institut
  amb ombres i triangles és 100 % visual i manipulatiu. Base directa a `2eso-ud5-4`,
  `2eso-ud5-5` i tota la `3eso-ud3`.
- **UD7 «Funcions: llegir i interpretar gràfics»** (`4eso-apl-ud7`) — també molt
  favorable, i la detecció de gràfics enganyosos (7.4) enllaça amb la U6.

**Si en algun moment cal retallar temari per a ell, retalla de la U4 (equacions) i no
d'aquestes.**
...
1. **El nivell d'assoliment esperat**, unitat per unitat. El PI l'ha de recollir perquè
   es pugui avaluar amb referència a ell i no al del grup.
...
- **La franja horària de la SIEI.** Si cau *després* de la introducció del tema a l'aula,
...
- **El material visual de fora ve amb la calculadora prohibida.** Gairebé tot el bon
  ...
  aquest alumne el càlcul és el vehicle, no l'objectiu, i l'argumentació oberta és el coll
