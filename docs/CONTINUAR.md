...
Hi ha material de Matemàtiques Aplicades adaptat per a alumnat amb
dificultats de tipus cognitiu.
...
**L'alumnat.** 15 anys, dificultats de tipus cognitiu, fa la meitat de les hores de matemàtiques a l'aula de suport i
l'altra meitat a l'aula ordinària, en l'itinerari d'Aplicades. El seu perfil és molt desigual, i
...
**El principi de tot el material:** aquest alumnat pot arribar a la *decisió* del nivell del grup, però
no al *càlcul* ni a la *redacció* del nivell del grup. Com que Matemàtiques Aplicades és la matèria de
...
secundària, un banc d'exercicis autocorrectius (`repas-main`) i les programacions didàctiques
...
l'articulació suport/aula ordinària, els criteris de disseny, l'inventari i el detall
...
1. **Blanc i negre estricte.** S'imprimeixen en B/N i no se sap com quedaran els colors.
   ...
   mantén-lo.*
2. **Cap paràgraf a les pàgines de l'alumnat.** El dibuix explica, les paraules només
...
7. **A cada unitat hi ha «la regla trencada»**: un exercici que trenca la regla que
   l'alumnat s'haurà fabricat als apartats anteriors. Està documentat al mapa, apartat 5.
...
1. **Quins models visuals fan servir i amb quina freqüència?** Concretament: doble recta
   ...
   models es repeteixen entre temes, perquè per a aquest alumnat **reutilitzar el mateix
...
3. **Com formulen les preguntes d'obertura?** Si són del tipus «què hi notes», és
   directament aprofitable: aquest alumnat té l'expressió escrita a nivell de 3r de
...
- La primera versió de la fitxa de la U1 tenia unes 700 paraules i em va dir que era
  **impossible** que l'alumnat la llegís. Tenia raó, i d'aquí va sortir tot el criteri de
  disseny.
