/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Còpia del de la caixa de 4eso/, amb una sola diferència: les claus del
   navegador comencen per «pi1-». Les dues caixes es publiquen al mateix domini
   i, si no, compartirien la memòria: una tasca a mitges de l'una sortiria a
   l'altra.
   ...
   «pi1-tasca:1.2». Al cap de 30 dies es descarta. Com que un ordinador de
...
(function () {
  ...
  const clau = cfg => "pi1-tasca:" + cfg.tasca + (cfg.sub ? "." + cfg.sub : "");
